...
namespace UITestsStudent
{
	public class UnitTest1
	{
		...
		public async Task Test1Async()
		{
			...
			textbox_text = textbox_s2.Text;
			need_text = "2";
			Assert.True(textbox_text.Equals(need_text), " After delete sred znach_2 != '2'");

			textbox_text = textbox_s3.Text;
			need_text = "1";
			Assert.True(textbox_text.Equals(need_text), " After delete sred znach_3 != '1'");

			textbox_text = textbox_s4.Text;
			need_text = "2";
			Assert.True(textbox_text.Equals(need_text), " After delete sred znach_4 != '2'");

			textbox_text = textbox_s5.Text;
			need_text = "0";
			Assert.True(textbox_text.Equals(need_text), " After delete sred znach_5 != '0'");

			textbox_text = textbox_s6.Text;
			need_text = "1.4";
			Assert.True(textbox_text.Equals(need_text), " After delete sred znach obshee != '1.4'");
